...
export default function Music() {
    return (
        <div className="items-center w-full h-screen overflow-auto bg-black scrollbar">
            ...
            {/* Hero */}
            <div className="relative flex items-end w-full h-[40vh] md:h-[60%] bg-cover bg-bottom" style={{ backgroundImage: `url(${me})` }}>
            ...
            {/* Content */}
            <div className="flex flex-col items-center w-full min-h-screen md:h-200 bg-[#111]">
                <div className="mt-10 md:mt-20 p-4 md:p-10 flex flex-col md:flex-row md:space-x-10 gap-6 md:gap-0 w-[95%] md:h-full bg-[#1c1c1c] rounded-4xl">

                    <AudioPlayer/>

                    <div className="flex flex-col w-full md:w-[30%] md:h-full rounded-4xl bg-[#3030308e] overflow-hidden shadow-2xl shadow-black">
