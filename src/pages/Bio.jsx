    ...
    const pageGradient = "bg-linear-to-br from-neutral-950/75 to-white/10 md:from-white/10 md:to-neutral-950/75 transition duration-800 hover:to-[#66666641] "
            ...
            <>
                ...
                ">
                    ...
                    <div className={`flex w-[90%] md:w-[60%] flex-col border-2 border-[#7373736f] ${pageGradient} mt-24 md:mt-40 rounded-4xl 
                        p-8 md:p-12 justify-start items-center space-y-4 shadow-2xl shadow-black backdrop-blur-sm`}>
                    ...
                    <div 
                        ...
                        border-2 border-[#a7a7a747] gap-8 md:h-[40%] backdrop-blur-sm"
                    >
                        {/* Experience */}
