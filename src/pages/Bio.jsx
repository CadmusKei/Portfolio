    ...
    return (
        <>
            ...
            <div className={`flex flex-col pl-20 w-full h-400 bg-cover `} style={{backgroundImage: `url(${backgroundPic})`}}>
                ...
                p-12 justify-start items-center space-y-4 shadow-2xl hover:to-[#07655841] transition duration-800 shadow-black`} >
                ...
                <div className={`flex w-[95%] flex-col h-[35%] ${pageGradient} mt-50 rounded-2xl 
