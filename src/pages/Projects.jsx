...
function Projects() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full h-screen bg-black z-0 hidden md:block" />
      <div className="fixed top-0 left-0 w-full md:w-[55%] h-full md:h-screen 
        bg-linear-to-br from-[#811964] to-[#110b39] z-0
        md:rounded-r-2xl md:shadow-[inset_0_-1rem_4rem] shadow-[#00000086]" />
      ...
      <div className="relative z-10 pt-16 md:pt-0">
        <ProjectTab id="#" image={nsdImage} scale="w-[90%]" name="NSD-RUN!" 
                    ...
                    The player must collect all stop sign shards whilst avoiding obstacles and fight the boss, 'Karen'."
        ...
        <ProjectTab id="verify" image={verifierImage} scale="w-[90%]" name="Verifier" 
                    ...
                    within 24 hours. The verifier implements encryption methods including RSA 
